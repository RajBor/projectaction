  ...
  return (
    <section className="dn-page dn-cover">
      ...
      <div className="bottom">
        ...
        price data hydrated from RapidAPI and event overlays derived from live news. Figures
    ...
    <section className="dn-page">
      ...
      <div className="dn-narrative" style={{ marginTop: 12 }}>
        <p className="dn-mutedtxt" style={{ fontSize: 9 }}>
          ...
          from RapidAPI historical prices (best-effort); private holdings use the entry EV
...
function AppendixPage({ portfolio }: { portfolio: Portfolio }) {
  return (
    <section className="dn-page">
      ...
      <div className="dn-narrative">
        <p>
          <strong>Listed holdings</strong> are priced via RapidAPI's Indian Stock Exchange
